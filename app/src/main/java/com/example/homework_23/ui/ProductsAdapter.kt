...
import com.example.homework_23.databinding.ItemProductBinding
import com.example.homework_23.domain.ProductModel

class ProductsAdapter(val viewModel: MainActivityViewModel) :
    ...
    inner class ProductViewHolder(private val binding: ItemProductBinding) :
        ...
        fun bind(product: ProductModel) {
            ...
            binding.checkbox.setOnClickListener {
                viewModel.changePurchaseStatus(product)
                updateStrikeThrough(product.purchased)
            }
        }
